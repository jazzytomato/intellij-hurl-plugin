...
public class HurlContainPredicateImpl extends HurlPredicateImpl implements HurlContainPredicate {

  public HurlContainPredicateImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitContainPredicate(this);
  }
