...
public class HurlXpathFilterImpl extends HurlFilterImpl implements HurlXpathFilter {

  public HurlXpathFilterImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitXpathFilter(this);
  }
