...
public class HurlOnelineFileImpl extends ASTWrapperPsiElement implements HurlOnelineFile {

  public HurlOnelineFileImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitOnelineFile(this);
  }
