...
public class HurlHttpStatusImpl extends ASTWrapperPsiElement implements HurlHttpStatus {

  public HurlHttpStatusImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitHttpStatus(this);
  }
