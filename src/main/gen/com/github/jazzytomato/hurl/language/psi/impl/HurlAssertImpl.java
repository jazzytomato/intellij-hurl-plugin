...
public class HurlAssertImpl extends ASTWrapperPsiElement implements HurlAssert {

  public HurlAssertImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public HurlPredicate getPredicate() {
    return findNotNullChildByClass(HurlPredicate.class);
  }
