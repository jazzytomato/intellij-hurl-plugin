...
public class HurlJsonpathFilterImpl extends HurlFilterImpl implements HurlJsonpathFilter {

  public HurlJsonpathFilterImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitJsonpathFilter(this);
  }
