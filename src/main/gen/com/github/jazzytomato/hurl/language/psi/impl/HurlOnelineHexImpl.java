...
public class HurlOnelineHexImpl extends ASTWrapperPsiElement implements HurlOnelineHex {

  public HurlOnelineHexImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitOnelineHex(this);
  }
