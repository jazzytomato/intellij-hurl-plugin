...
public class HurlNetrcOptionalOptionImpl extends HurlOptionImpl implements HurlNetrcOptionalOption {

  public HurlNetrcOptionalOptionImpl(@NotNull ASTNode node) {
    super(node);
  }
