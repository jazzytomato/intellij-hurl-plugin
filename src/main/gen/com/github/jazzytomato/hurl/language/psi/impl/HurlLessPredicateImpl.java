...
public class HurlLessPredicateImpl extends HurlPredicateImpl implements HurlLessPredicate {

  public HurlLessPredicateImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitLessPredicate(this);
  }
