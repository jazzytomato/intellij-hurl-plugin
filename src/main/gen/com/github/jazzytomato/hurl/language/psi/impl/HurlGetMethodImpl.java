...
public class HurlGetMethodImpl extends ASTWrapperPsiElement implements HurlGetMethod {

  public HurlGetMethodImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitGetMethod(this);
  }
