...
public class HurlFollowRedirectOptionImpl extends HurlOptionImpl implements HurlFollowRedirectOption {

  public HurlFollowRedirectOptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitFollowRedirectOption(this);
  }
