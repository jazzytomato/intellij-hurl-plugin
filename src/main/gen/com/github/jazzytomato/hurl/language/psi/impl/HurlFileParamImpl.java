...
public class HurlFileParamImpl extends ASTWrapperPsiElement implements HurlFileParam {

  public HurlFileParamImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public HurlFileValue getFileValue() {
    return findNotNullChildByClass(HurlFileValue.class);
  }
