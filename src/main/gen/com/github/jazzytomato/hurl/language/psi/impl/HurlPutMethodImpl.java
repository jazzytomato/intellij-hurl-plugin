...
public class HurlPutMethodImpl extends ASTWrapperPsiElement implements HurlPutMethod {

  public HurlPutMethodImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitPutMethod(this);
  }
