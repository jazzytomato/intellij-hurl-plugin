...
public class HurlStartWithPredicateImpl extends HurlPredicateImpl implements HurlStartWithPredicate {

  public HurlStartWithPredicateImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitStartWithPredicate(this);
  }
