...
import com.github.jazzytomato.hurl.language.psi.HurlRegexString;
...
public class HurlRegexStringImpl extends ASTWrapperPsiElement implements HurlRegexString, PsiLanguageInjectionHost {

  public HurlRegexStringImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitRegexString(this);
  }
  ...
  public @NotNull LiteralTextEscaper<? extends PsiLanguageInjectionHost> createLiteralTextEscaper() {
    return new LiteralTextEscaper<HurlRegexStringImpl>(this) {
      @Override
