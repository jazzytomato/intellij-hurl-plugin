...
public class HurlJsonpathImpl extends ASTWrapperPsiElement implements HurlJsonpath, PsiLanguageInjectionHost {

  public HurlJsonpathImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitJsonpath(this);
  }
  ...
  public @NotNull LiteralTextEscaper<? extends PsiLanguageInjectionHost> createLiteralTextEscaper() {
    return new LiteralTextEscaper<HurlJsonpathImpl>(this) {
      @Override
